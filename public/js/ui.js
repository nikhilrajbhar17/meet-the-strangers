...
export const showRecordingPanel  = () =>{
  ...
  // hide start recording button if it is actice
  const startRecordingButton = document.createElement('start_recording_button');
...
// ui after hanged up
 export const updateUIAfterHangUp = (callType) =>{
  ...
  // hide rmote video and show placeholder
  const remoteVideo = document.getElementById('remote_video');
